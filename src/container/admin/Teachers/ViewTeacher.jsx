...
export default function ViewTeacher() {
   ...
   const cardArr = [
      ...
      cardFunc("Email", personal_info.email),
   ...
   const getTeacher = async () => {
      try {
         const response = await adminGetHandler(`/admin/get-teacher/${id}`, loaderState);
         setPersonal_info(response.teacherData.personal_info);
      ...
      <Menu>
         ...
         <div className="container">
            <div className="flex justify-between items-center bg-white rounded-xl p-2 px-4">
               ...
               <div className="text-wrap">
                  <span className="text-lg font-bold">Email</span> <br />
                  <span className="text-sm text-slate-600">
                     {personal_info.email}
                  </span>
               </div>
               ...
               <div className="text-wrap">
                  <span className="text-lg font-bold">Phone</span> <br />
                  <span className="text-sm text-slate-600">
                     {personal_info.phone}
                  </span>
               </div>
               ...
               <div className="btn-wrap">
                  <button className=" btn btn-danger">Rusticate</button>
               </div>
            </div>
         </div>
