...
export default function MessageCard({title, description}) {
   ...
   return (
      <div
         className=" wrap flex  gap-4 justify-between mb-3 items-center border-bottom bg-pri text-white  px-3 p-2 rounded-lg"
      >
         <div className={`${show ? "break-words" : "truncate"} col-6`}>
